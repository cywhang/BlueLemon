									...
									<div class="row justify-content-center">
										<div class="col-lg-12">
											<div class="form-floating mb-3 d-flex align-items-end">
                              				...
                              				<div class="form-floating mb-3 d-flex align-items-end">
                                 				<input type="password" class="form-control rounded-5" id="member_Password" name="member_Password" value="${loginUser.member_Password}" maxlength="12">
                                 				<span id="password_message" class="error-message"></span>
                                 				<label for="floatingssName">PASSWORD</label>
                              				</div>
                              				<div class="form-floating mb-3 d-flex align-items-end">
				                                <input type="password" name="repassowrd" class="form-control rounded-5" id="repassword" placeholder="#" value="${loginUser.member_Password}" maxlength="12">
				                                <span id="confirm_password_message" class="error-message"></span>
				                                <label for="floatingssName">REPASSWORD</label>
                              				</div>
                             				<div class="form-floating mb-3 d-flex align-items-end">
				                                <input type="text" class="form-control rounded-5" id="member_Name" name="member_Name" value="${loginUser.member_Name}" readonly>
				                                <span id="name_error_message" class="error-message"></span>
				                                <label for="floatingssName">NAME</label>
                              				</div>                                 
											<div class="form-floating mb-3 d-flex align-items-center">
				                                <input type="text" class="form-control rounded-5" name="member_Email" id="member_Email" value="${member_Email}">
				                                @
				                                <input type="text" class="form-control rounded-5" name="email_add" id="email_add" value="${email_add}">
