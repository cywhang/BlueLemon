               ...
               <div class="main-content">
                  ...
                  <div class="feeds">
                     ...
                     <div class="bg-white p-3 feed-item rounded-4 mb-3 shadow-sm">
                        <div class="d-flex">
                           <img src="img/rmate2.jpg" class="img-fluid rounded-circle user-img" alt="profile-logo">
                              ...
                              <div class="w-100">
                                 ...
                                 <div class="my-2">
                                    ...
                                    <ul class="list-unstyled mb-3">
                                       <li>1. Follow people you like by clicking on the â+ Followâ button to see their posts in your feed.</li>
                     ...
                     <div class="bg-white p-3 feed-item rounded-4 mb-3 shadow-sm">
                        <div class="d-flex">
                           <img src="img/rmate5.jpg" class="img-fluid rounded-circle user-img" alt="profile-img">
                           <div class="d-flex ms-3 align-items-start w-100">
                              <div class="w-100">
                                 <div class="d-flex align-items-center justify-content-between">
                                    <a href="profile" class="text-decoration-none d-flex align-items-center">
                                       <h6 class="fw-bold mb-0 text-body">ABCD Secure</h6>
                                       <span class="ms-2 material-icons bg-primary p-0 md-16 fw-bold text-white rounded-circle ov-icon">done</span>
                                       <small class="text-muted ms-2">@abcdsec</small>
                                    </a>
                                    <div class="d-flex align-items-center small">
                                       <p class="text-muted mb-0">19 Feb</p>
                                       <div class="dropdown">
                        ...
                        <div class="d-flex">
                           ...
                           <div class="d-flex ms-3 align-items-start w-100">
                              <div class="w-100">
                                 <div class="d-flex align-items-center justify-content-between">
                                    <a href="profile" class="text-decoration-none d-flex align-items-center">
                                       <h6 class="fw-bold mb-0 text-body">Anisa Keena</h6>
                                       <span class="ms-2 material-icons bg-primary p-0 md-16 fw-bold text-white rounded-circle ov-icon">done</span>
                                       <small class="text-muted ms-2">@kanganaranaut</small>
                                    </a>
                                    <div class="d-flex align-items-center small">
                                       <p class="text-muted mb-0">19 Feb</p>
                                       <div class="dropdown">
               ...
               <div class="p-2 bg-light offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample">
                  <div class="sidebar-nav mb-3">
                     ...
                     <ul class="navbar-nav justify-content-end flex-grow-1">
                        ...
                        <li class="nav-item">
                           <a href="explore" class="nav-link"><span class="material-icons me-3">explore</span> <span>Explore</span></a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                           ...
                           <ul class="dropdown-menu px-2 py-1 mb-2">
                              ...
                              <li><a class="dropdown-item rounded-3 px-2 py-1 my-1" href="edit-profile">Edit Profile</a></li>
                           </ul>
                        </li>
                        <li class="nav-item">
                           <a href="tags" class="nav-link active"><span class="material-icons me-3">local_fire_department</span> <span>Trending</span></a>
                        </li>
                     </ul>
                  </div>
                        ...
                        <div class="bg-white rounded-4 overflow-hidden shadow-sm mb-4">
                           ...
                           <a href="tags" class="p-3 border-bottom d-flex align-items-center text-dark text-decoration-none">
                              <div>
                                 ...
                                 <p class="fw-bold mb-0 pe-3">Happy birthday, Osahan ð</p>
      ...
      <div class="py-3 bg-white footer-copyright">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-md-8">
                  <span class="me-3 small">Â©2023 <b class="text-primary">Your Website</b>. All rights reserved</span>
               </div>
