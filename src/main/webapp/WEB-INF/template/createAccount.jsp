						...
						<div class="main-content">
							<div class="mb-5">
								<header class="profile d-flex align-items-center">
                                	<img src="img/login_Logo.png" style = "width : 50%; height : auto; margin-left : 25%;">
								</header>	
								<div>
									<span class="text-muted text_short" style = "margin-left : 37%;">WELCOME SIGN UP</span>
								</div>
							</div>
						</div>
						<!-- Feeds -->
							...
							<div class="bg-white p-4 feed-item rounded-4 shadow-sm mb-3 faq-page">
								...
								<div class="row justify-content-center">
									<div class="col-lg-12" style = "margin-bottom : 5%;">
										...
										<div class="form-floating mb-3 d-flex align-items-center">
											<input type="text" class="form-control rounded-5" name="member_Phone" id="member_Phone">
