                     ...
                     <div class="main-content">
                        <div class="mb-5">
                           <header class="profile d-flex align-items-center">
                              <img src="img/login_Logo.png" style = "width : 30%; height : 20%">
                           </header>
                           <div style = "text-align : center;">
                              <h4 class="mb-0 text-dark"><span class="fw-bold">WELCOME SIGN UP</span></h4>
                           </div>
                        </div>
                        <!-- Feeds -->
                        <div class="feeds">
                           ...
                           <div class="bg-white p-4 feed-item rounded-4 shadow-sm mb-3 faq-page">
                              ...
                              <div class="row justify-content-center">
                                 <div class="col-lg-12">
                                    <label class="mb-2 text-muted small">필수 입력 항목</label>
                                    <div class="form-floating mb-3 d-flex align-items-end">
                                       ...
                                       <button type="button" id="check_duplicate_button" class="btn btn-primary rounded-5 w-50 text-decoration-none py-3 fw-bold text-uppercase m-0">
                                          중복 체크
                                       </button>
                                    ...
                                    <div style = "margin-top : 10px;">
                                       <label class="mb-2 text-muted small">선택 입력 항목</label>
	                                   <div class="form-floating mb-3 d-flex align-items-center">
