...
<html lang="en">
   ...
   <body class="bg-light">   
      ...
      <div class="p-5 text-center">
         <img src="img/429.svg" class="img-fluid col-md-4" alt="osahan">
         <div class="text-center pb-5">
            <h2 class="fw-bold text-black mt-4">Oh no! Too many people inside.</h2>
            <p class="mb-4">Please visit later, there is too many people crowded.</p>
